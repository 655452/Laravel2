                    ...
                    <div class="card">
                        @can('tables_create')
                            <div class="card-header">
                                <a href="{{ route('admin.tables.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> {{ __('table.add_tables') }}</a>
                            </div>
                        @endcan
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="maintable" data-url="{{ route('admin.tables.index') }}" data-status="{{ \App\Enums\Status::ACTIVE }}" data-hidecolumn="{{ auth()->user()->can('tables_edit') || auth()->user()->can('tables_delete') }}">
                                    <thead>
                                        <tr>
                                            <th>{{ __('levels.id') }}</th>
                                            <th>{{ __('levels.name') }}</th>
                                            <th>{{ __('levels.capacity') }}</th>
