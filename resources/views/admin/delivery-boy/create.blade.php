					    	...
					    	<div class="card-body">
				                ...
				                <div class="form-row">
				                	...
				                	<div class="form-group col">
                                        ...
                                        <input type="number" step=".01" name="deposit_amount" class="form-control @error('deposit_amount') is-invalid @enderror" value="{{ old('deposit_amount') }}">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="number" step=".01" name="limit_amount" class="form-control @error('limit_amount') is-invalid @enderror" value="{{ old('limit_amount') }}">
                                        @error('limit_amount')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
